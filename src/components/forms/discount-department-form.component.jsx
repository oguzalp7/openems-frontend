...
import { Box, useToast, Tag, TagLabel, TagCloseButton, Divider, Text, HStack, VStack, Input, Button } from '@chakra-ui/react';
...
const DiscountDepartmentForm = ({ onSubmit, onCancel }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const data = {payload: {start_date: startDate, end_date: endDate, percentage: percentage,  process_ids: "[" + buffer.map(p => p.id).toString() + "]" }, dep: selectedDepartment};
